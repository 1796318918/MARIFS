...
class ActorCritic(nn.Module):
    ...
    def forward(self, state):
        ...
        masked_probs[1:465] = masked_probs[1:465].masked_fill(state_mask_1, float('-inf'))
        masked_probs[466:930] = masked_probs[466:930].masked_fill(~state_mask_2, float('-inf'))
...
if __name__ == "__main__":
    ...
    print(args.index)
    dataset = pd.read_csv('../data/PPMI_2classes_' + str(args.index) + '.csv')
    ...
    sio.savemat(save_adr, {'state1': state})

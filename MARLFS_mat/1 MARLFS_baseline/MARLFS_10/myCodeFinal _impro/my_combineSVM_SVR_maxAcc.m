function [svmMaxAcc,accSen,accSpec,accPrec,accFscore,maxAuc,maxAcc,minArmse,maxBcc,minBrmse,Rs,Ra,Rb]=...
    my_combineSVM_SVR_maxAcc(trainData,trainFlag,trainScoresA,trainScoresB,testData,testFlag,testScoresA,testScoresB,parc,parg)
